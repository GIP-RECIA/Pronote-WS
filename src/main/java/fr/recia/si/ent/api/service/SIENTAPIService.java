...
public interface SIENTAPIService {
    Map<String,Object> getUserInfos(final String externalId) throws NotFoundIdException;
    List<Map<String,Object>> getChildrensOf(final String externalId) throws NotFoundIdException;
}
