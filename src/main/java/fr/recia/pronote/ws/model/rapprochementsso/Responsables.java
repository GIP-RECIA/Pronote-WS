...
public class Responsables {
    ...
    @XmlElement(name = "Responsable", namespace = "http://www.index-education.com/rapprochementssoV2.0", required = true)
    protected List<Responsable> responsables = new ArrayList<>();
